...
const resources = {
  en: {
    translation: {
      ...
      // Dashboard Section
      'Dashboard_Note': 'Note:',
      'Dashboard_Note_Text': 'These values are calculated automatically based on the data entered in the Staff and Budget sections.',
      'Dashboard_Note_Instruction': 'Ensure all budget achievements and staff counts are up-to-date for accurate results.',
      // Navigation Tabs
  ...
  fr: {
    translation: {
      ...
      'Dashboard_Note_Text': 'Ces valeurs sont calculées automatiquement en fonction des données saisies dans les sections Personnel et Budget.',
      'Dashboard_Note_Instruction': 'Assurez-vous que toutes les réalisations budgétaires et les effectifs du personnel sont à jour pour des résultats précis.',
      // Navigation Tabs
