        ...
        <table className="w-full text-xs border-collapse">
          <thead className="bg-gradient-to-r from-slate-100 to-slate-50">
            <tr className="border-b-2 border-slate-300">
              <th className="px-3 py-2 w-16 text-center font-semibold text-slate-700 border-r border-slate-200">{t('No.')}</th>
              ...
              <th className="px-3 py-2 w-24 text-center font-semibold text-slate-700">{t('Actions')}</th>
            </tr>
          </thead>
          <tbody>
